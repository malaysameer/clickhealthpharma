package com.clickhealth.pharma.auth.model;
...
public class LoginResponse {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link LoginResponse#LoginResponse(String, String, Integer)}
   */
  @Deprecated
  ...
  */
  @NotNull 
  @Schema(name = "accessToken", description = "JWT token", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "expiresIn", description = "Expiry time in seconds", requiredMode = Schema.RequiredMode.REQUIRED)
